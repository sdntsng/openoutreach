...
- Dashboard auth: `AUTH_MODE=hosted` (Better Auth email/password + optional Google; Settings invites) or `cloudflare_access` (Access OTP/IdP). Optional `AUTH_ALLOWED_EMAILS`.
